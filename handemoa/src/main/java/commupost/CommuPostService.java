...
public interface CommuPostService {

	List<CommuPostVO> commuPostListView(String catedetailname);
	List<CommuPostVO> commuPostListViewInt(int catedetailcode, int viewPage);
	...
	List<CommuBoardVO> commuBoardList(String catedetailname);
	List<CommuBoardVO> commuBoardListInt(int catedetailcode);
