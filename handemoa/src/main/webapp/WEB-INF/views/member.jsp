					...
					<form action="memberinsert" class="signup_form" method="post">
						...
						<div class="item">
							...
							<div id="nickname">
								...
								<div id="nickname_box">
									<input id=nickname_nickname class=class_nickname type=text
										...
										pattern="[a-zA-Z0-9가-힣]{2,12}" title="2~12자의 한글,영문,숫자만 가능합니다.">
								</div>
								<button id="repeat_check_nickname" type="button">중복확인</button>
							</div>
							<font id="nicknamecheck_font" size="2"></font> <br>
							<br>
							<br>
							...
							<div id="email">
								...
								<button id="repeat_check_email" type="button">중복확인</button>
							...
							<font id="phonecheck_font" size="2"></font> <br> <br> <br>
							...
							<div id="birth">
								...
								<div id="birth_box">
									...
									<input type="hidden" name="birth"> <input type="text" id="birth_yy"
										name="birth_yy" class="int" maxlength="4" placeholder="년(4자)"
										pattern="[0-9]{4,4}" title="년도를 정확히 입력해주세요. 예)2000">
									...
									<!-- BIRTH_DD -->
									<input id="birth_dd" type="text" name="birth_dd" class="int" maxlength="2"
										placeholder="일" pattern="[0-9]{1,2}">
