...
<link rel='stylesheet' type='text/css' href='/css/adminreport/postreport.css'>
<script type="text/javascript" src='/js/adminreport/adminreport.js'></script>
<script type="text/javascript" src='/js/adminreport/postreport.js'></script>
</head>
<body>
						...
						<c:forEach var="post" items="${postReportList}" varStatus="i">
							<div class="list_body">
								<div class="list_row">
									...
									<div class="report"><a href="/profile?nickname=${post.nickname}" target="_blank">${post.nickname}</a></div>
									<div class="report">
