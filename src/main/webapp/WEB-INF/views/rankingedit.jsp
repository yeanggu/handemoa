...
<script src='/js/alarm.js'></script>
    ...
    $('#temp_write_btn').click(function () {
        console.log("임시저장 게시");
        editpost(1);
    });

    function editpost(tempsave) {
        ...
        success: function (a) {
            ...
            if (a == 1) {
                console.log("글 수정 성공");
                location.replace("/rankingpost?postnum="+$('#getpostnum').val());
                }
            }        
        });
    }
                            ...
                            <div id="rank_post_list">
                                ...
                                <div id="rank_post">
                                    <!-- 반복할 게시물 시작 -->
                                        ...
                                        강의저자 <input type="text" name="author" id="author" value="${vo.author}">
                                        강의제목 <input type="text" name="classtitle" id="classtitle" value="${vo.classtitle}"><br>
                                        제목 <input type="text" name="posttitle" id="posttitle" value="${vo.posttitle}"><br>
                                        내용 <textarea name="content" id="post_content">${vo.content}</textarea><br>
                                        링크 <input type="text" name="link" id="link" value="${vo.link}"><br><br>
                                        썸네일<br>
                                ...
                                <div class="inner_space"></div>
                                <div>
                                    <c:if test="${vo.tempsave != 0}">
                                        <button class="btn" id="edit_btn">수정</button>
                                        <a href="/ranking?catedetailcode=${catedetailcode}&page=1"><button class="btn">목록</button></a>
                                    </c:if>
                                    <c:if test="${vo.tempsave == 0}">
                                        <button class="btn" id="temp_edit_btn">임시저장 수정</button>
                                        <button class="btn" id="temp_write_btn">게시</button>
                                        <a href="/ranking?catedetailcode=${catedetailcode}&page=1"><button class="btn">목록</button></a>
                                    </c:if>
                                </div>
                                <div class="inner_space"></div>
